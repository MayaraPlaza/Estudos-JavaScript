...
// Cada variável desta recebe 1 entrada, Exemplo:
// precoAlcool = 1.20 reais
// precoGasolina  2.30 reais
// rendimentoAlcool = 10.00 km/L
// rendimentoGasolina = 15.00 km/L
const [precoAlcool, precoGasolina, rendimentoAlcool, rendimentoGasolina] = 
  lines[0].split(' ').map(x => parseFloat(x));

// O preço por Kilometragem consiste em dividir o km/L pelo preço
// pois cada litro tem 1 preço, se temos Y kilômetros por litro, logo
// é Y kilômetros por preço (divisão).
